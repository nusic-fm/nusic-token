...
export async function run(provider: NetworkProvider) {
    ...
    const minterCode = await compile('NusicJettonMinter');
    let   done   = false;
    let   retry:boolean;
    ...
    minterContract = provider.open(NusicJettonMinter.createFromAddress(minterAddress));
